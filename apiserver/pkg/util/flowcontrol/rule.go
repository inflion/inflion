...
import (
	...
	"github.com/inflion/inflion/apiserver/pkg/authentication/serviceaccount"
...
// This is copied from `github.com/inflion/inflion/apiserver/pkg/authentication/serviceaccount::MatchesUsername` and simplified to not check the name part.
